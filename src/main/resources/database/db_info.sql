...
VALUES
    ...
    ('Pasco', '00:12:21', 'Saggezza'),
    ('Mik', '00:04:20', 'Saggezza');
...
INSERT INTO DESCRIZIONI (ID, COMANDO, STANZA, STATO, PERSONAGGIO, OGGETTO1, OGGETTO2, DESCRIZIONE) VALUES
    ...
    (7, 'Parla', 'Desert', 'Sbagliato', 'Sfinge', '0', '0', '> "Il tuo insuccesso, ci ha ammaliati e il mio amico cane qui vorrebbe farti i complementi per tale impresa" '),
    ...
    (30, '0', 'Stanza2', 'SerpentiOn', '0', '0', '0', '> Entrando nella stanza, noti una torcia con il simbolo 1 incavata su di essa, che potrebbe tornare utile in caso di stanze buie, il problema è che nel mezzo della stanza è presente una fossa piena di serpenti.'),
    ...
    (37, 'Osserva', '0', '0', '0', 'Torcia1', '0', '> Una torcia, noti che ha dei segni sul manico potrebbe indicare che deve essere inserita in un meccanismo.'),
    ...
    (39, '0', 'Stanza3', 'AcquaOn', '0', '0', '0', '> Entrando nella stanza, noti che dal soffitto scorre dell''acqua e dall''altro lato intravedi una torcia col simbolo 2, potrebbe tornarti utile.'),
    (40, 'Osserva', 'Stanza3', 'AcquaOn', '0', '0', '0', '> Nella stanza noti un coltello per terra e una leva sul soffitto.'),
    (41, 'Osserva', 'Stanza3', 'AcquaOn', '0', 'Leva', '0', '> Un marchingegno collegato alla corrente d''acqua.'),
    (42, 'Osserva', 'Stanza3', 'AcquaOff', '0', 'Leva', '0', '> Un marchingegno collegato alla corrente d''acqua.'),
    (43, 'Usa', 'Stanza3', 'AcquaOn', '0', 'Corda', 'Leva', '> Leghi la corda alla leva, tirando la leva, l''acqua smette di scorrere.'),
    (44, 'Osserva', 'Stanza3', 'AcquaOff', '0', '0', '0', '> Ora intravedi meglio l''altro lato della stanza e noti la torcia con il simbolo 2 incavato su di essa, noti anche una brace di ferro, incastrata nel pavimento, accanto alla torcia.'),
    ...
    (47, 'Prendi', 'Stanza3', 'AcquaOn', '0', 'Torcia2', '0', '> Cerchi di prendere la torcia, ma l''acqua spegne la torcia.'),
    (48, 'Prendi', 'Stanza3', 'AcquaOff', '0', 'Torcia2', '0', '> Prendi la torcia con successo, portandola al lato opposto.'),
    ...
    (51, 'Usa', 'Stanza1', 'Luce', '0', 'Torcia1', 'Statua', '> Inserisci la Torcia dentro l''incavo della statua, viene inserita correttamente.'),
    (52, 'Usa', 'Stanza1', 'Torcia1', '0', 'Torcia2', 'Statua', '> La statua si apre come una porta e rivela il passaggio successivo.'),
    ...
    (57, 'Osserva', 'Stanza1', 'Torcia2', '0', 'Statua', '0', '> La statua ormai ora aperta rappresentava un faraone.'),
    ...
    (83, 'Usa', 'Stanza8', 'Start', '0', 'ImpastoCompleto', 'Fuoco', '> Il fuoco sembra attirato dall''impasto, lo cuoce in tempi record così da ottenere un impasto cotto.'),
    (84, 'Unisci', '0', '0', '0', 'ImpastoCotto', 'LatteVecchio', '> Ricopri l''impasto cotto con il latte vecchio ormai semisolido così da creare una torta.'),
    (85, 'Unisci', '0', '0', '0', 'LatteVecchio', 'ImpastoCotto', '> Ricopri l''impasto iotto con il latte vecchio ormai semisolido così da creare una torta.'),
    ...
    (87, 'Usa', 'Stanza8', 'Start', '0', 'Torta', 'Piedistallo', '> Poggiando la torta sul piedistallo, sembra che piano piano venga mangiata; ti viene offerto l''Ankh in cambio.'),
    ...
    (99, '0' ,'Stanza10', 'OssirideStart', '0' ,'0', '0', '> Appena entri nella stanza, il faraone ti fissa intensamente a ogni tuo minimo movimento.'),
    ...
    (102, 'Dai', 'Stanza10', 'OsirideStart', 'Osiride', 'Ankh', '0', '> "La chiave della vita, un oggetto che dona l''immortalità degli dei a chi lo possiede. Ti ringrazio per questo dono"'),
    (103, 'Dai', 'Stanza10', 'OsirideHekat', 'Osiride', 'Ankh', '0', '> "La chiave della vita, un oggetto che dona l''immortalità degli dei a chi lo possiede. Ti ringrazio per questo dono"'),
    (104, 'Dai', 'Stanza10', 'OsirideNekhekh', 'Osiride', 'Ankh', '0', '> La chiave della vita, un oggetto che dona l''immortalità degli dei a chi lo possiede. Ti ringrazio per questo dono"'),
    (105, 'Osserva', 'Stanza10', 'OsirideAnkh', 'Osiride', '0', '0', '> Osiride posiziona l''Ankh sul suo petto, che si attacca come un magnete, adesso sprigiona una grande luce e il faraone sembra ringiovanito.'),
    (106, 'Dai', 'Stanza10', 'OsirideStart', 'Osiride', 'Hekat', '0', '> "Lo scettro di un sovrano, fonte di un potere che solo in pochi possono gestire. Ti ringrazio per questo dono"'),
    (107, 'Dai', 'Stanza10', 'OsirideAnkh', 'Osiride', 'Hekat', '0', '> "Lo scettro di un sovrano, fonte di un potere che solo in pochi possono gestire. Ti ringrazio per questo dono"'),
    (108, 'Dai', 'Stanza10', 'OsirideNekhekh', 'Osiride', 'Hekat', '0', '> "Lo scettro di un sovrano, fonte di un potere che in solo pochi possono gestire. Ti ringrazio per questo dono"'),
    (109, 'Osserva', 'Stanza10', 'OsirideHekat', 'Osiride', '0', '0', '> Osiride impugna lo scettro arcuato con la mano destra portandolo a sé ed inclinandolo verso destra, adesso il faraone sembra avere un aspetto più autoritario.'),
    (110, 'Dai', 'Stanza10', 'OsirideStart', 'Osiride', 'Nekhekh', '0', '> "Un oggetto magico utile alla difesa del potere di un sovrano, così che possa governare incontrastato. Ti ringrazio per questo dono"'),
    (111, 'Dai', 'Stanza10', 'OsirideAnkh', 'Osiride', 'Nekhekh', '0', '> "Un oggetto magico utile alla difesa del potere di un sovrano, così che possa governare incontrastato. Ti ringrazio per questo dono"'),
    (112, 'Dai', 'Stanza10', 'OsirideHekat', 'Osiride', 'Nekhekh', '0', '> "Un oggetto magico utile alla difesa del potere di un sovrano, così che possa governare incostrastato. Ti ringrazio per questo dono"'),
    (113, 'Osserva', 'Stanza10', 'OsirideNekhekh', 'Osiride', '0', '0', '> Osiride impugna il flagello con la mano sinistra portandolo a sé ed inclinandolo verso sinistra, adesso il faraone dà la sensazione di essere una statua.'),
    (114, '0', 'Stanza10', 'OsirideEnd', '0', '0', '0', '> La stanza appare illuminata da luce solare proveniente dal corpo di Osiride.'),
    (115, 'Osserva', 'Stanza10', 'OsirideEnd', '0', '0', '0', '> La stanza sembra illuminata da luce solare proveniente dal corpo di Osiride.'),
    (116, 'Osserva', 'Stanza10', 'OsirideEnd', 'Osiride', '0', '0', '> Il faraone, ora ringiovanito, autoritario e statuario, si alza in piedi ed un bagliore accecante lo avvolge. Attenuatosi, davanti ai tuoi occhi si rivela una figura liberata dai vecchi bendaggi e dai supplizi della morte: Osiride ora indossa una lunga veste azzurra ed è ornato dalla testa ai piedi di oro e pietre e preziose. Il suo volto, nonostante la carnagione verdastra, ti ipnotizza data la sua rara bellezza e l''aria di saggezza che lo contraddistinguono. La sua testa è infine ornata da un grande copricapo bianco che corona la sua apparenza chiaramente divina.'),
    (117, 'Parla', 'Stanza10', 'OsirideEnd', 'Osiride', '0', '0', '> "Congratulazioni, viaggiatore. Hai raggiunto il tuo obiettivo ultimo e per questo sarai ricompensato. Ora scegli il tuo premio: ricchezza o saggezza? Sotto questa stanza si trovano innumerevoli tesori d''ogni genere, una fortuna oltre qualsivoglia immaginazione, sceglila e sarà tua. Al di sopra di questa stanza, invece, si trova l''universo con le sue infinite meraviglie, sceglilo e ti accompagnerò nel tuo viaggio verso la conoscenza. Allora cosa desideri? Ricchezza o saggezza?"'),
    (118, '0', 'Stanza10', 'Ricchezza', '0', '0', '0', '> "Ebbene hai scelto i vizi mortali, procedi! Il tesoro è tuo." Il sarcofago si sposta rivelando delle scale, scendendole ti trovi nella stanza più grande vista fino ad ora e piena zeppa di scrigni, gemme, dobloni, gioielli, tessuti preziosi, profumi ed ogni genere d''oggetto fatto d''oro massiccio. Ma il tuo stupore e la tua gioia hanno vita breve, senti il sarcofago richiudere il passaggio da cui sei appena sceso. Dall''esterno senti la voce di Osiride: "Goditi le tue ricchezze, poiché sono tutto quello che ti resta ora, hai affrontato bene la mia piramide, ma il tuo cuore non va di pari passo col tuo spirito d''avventura. Ci rivedremo a breve, che le tue virtù possano alleggerire il peso del tuo cuore sulla bilancia e che tu sfugga alla pena della Duat"'),
    (119, '0', 'Stanza10', 'Saggezza', '0', '0', '0', '> "Ebbene hai scelto il sapere divino, procedi!" Il soffitto si apre rivelando delle scale, Osiride ti precede nel salirle ed arrivati in cima ti ritrovi in una libreria sospesa nel cielo con libri che possono rispondere a qualsivoglia quesito. Ma il tuo stupore dura poco quando si presenta di fronte a te Thot che ti parla:"I vivi non sono benvenuti nel dominio della saggezza". Il pavimento sparisce da sotto i tuoi piedi, cadi rovinosamente verso il stesso deserto in cui ti trovavi fino a poco fa, impatti il suolo e subito dopo ti risvegli nuovamente davanti a Thot, che ora ti sorride.'),
    ...
    (122, 'Osserva', '0', '0', '0', 'FrecciaSpuntata', '0', '> Una freccia con la punta arrotondata per non rischiare che qualcuno si faccia male, le manca anche la coda.'),
    ...
    (126, 'Usa', '0', '0', '0', 'Coltello', 'FrecciaSpuntata', '> Limi la punta della freccia per renderla appuntita.'),
    (127, 'Unisci', '0', '0', '0', 'Piuma', 'FrecciaAffilata', '> Incavi un buco alla fine della freccia per potervi inserire la piuma, rendendola aereodinamica, ottieni così una freccia in tutto per tutto.'),
    (128, 'Unisci', '0', '0', '0', 'FrecciaAffilata', 'Piuma', '> Incavi un buco alla fine della freccia per potervi inserire la piuma, rendendola aereodinamica, ottieni così una freccia in tutto per tutto.'),
    (129, 'Unisci', '0', '0', '0', 'FrecciaSpuntata', 'Piuma', '> Incavi un buco alla fine della freccia per potervi inserire la piuma, rendendola aereodinamica.'),
    (130, 'Unisci', '0', '0', '0', 'Piuma', 'FrecciaSpuntata', '> Incavi un buco alla fine della freccia per potervi inserire la piuma, rendendola aereodinamica.'),
    (131, 'Usa', '0', '0', '0', 'Coltello', 'FrecciaPiuma', '> Limi la punta della freccia per renderla appuntita, ottieni così una freccia in tutto per tutto.'),
    ...
    (139, '0', 'Stanza5', 'Start', '0', '0', '0', '> Entri nella stanza che apparentemente sembra vuota, sopra il soffitto è presente quello che sembra un occhio di vetro.'),
    (140, 'Osserva', 'Stanza5', 'Start', '0', '0', '0', '> Noti che per terra sono presenti un arco rotto senza spago e una freccia spuntata.'),
    (141, 'Osserva', 'Stanza5', 'Start', '0', 'Occhio', '0', '> Un occhio di vetro, appena ti sposti sembra seguirti con lo sguardo.'),
    (142, 'Usa', 'Stanza5', 'Start', '0', 'ArcoFreccia', 'Occhio', '> Carichi l''arco e scocchi la freccia colpendo con precisione l''occhio di vetro.'),
    ...
    (147, '0', 'Stanza7', 'Sbagliato', '0', 'Mattonella', '0', '> Sbagliando mattonella delle trappole si attivano, ma una forza ti prende prima che tu possa essere colpito riportandoti all''inizio della stanza. Una voce ti dice:"You cannot give up just yet... Stay determined"'),
    (148, '0', 'Stanza7', 'Corretto', '0', 'Mattonella', '0', '> Sei arrivato alla fine della sfida, il Nekhekh è proprio di fronte a te.'),
    ...
    (155, 'Usa', 'Stanza9', 'Start', '0', 'Olio', 'Buca', '> Versi l''olio nel buco, un rumore nella stanza sembra segnare l''ordine corretto dell''inserimento.'),
    (156, 'Usa', 'Stanza9', 'Olio', '0', 'Vetro', 'Buca', '> Poggi il vetro sul buco, un rumore nella stanza sembra segnare l''ordine corretto dell''inserimento.'),
    (157, 'Usa', 'Stanza9', 'Vetro', '0', 'Acqua', 'Buca', '> Versi l''acqua sopra il vetro, la luce riflessa attraverso l''acqua e il vetro fa incendiare l''olio creando una fiamma: un meccanismo rivela l''Hekat davanti ai tuoi occhi.'),
    ...
    (166, 'Usa', 'Stanza1', 'Luce', '0', 'Torcia2', 'Statua', '> Inserisci la Torcia dentro l''incavo della statua, viene inserita correttamente.'),
    (167, 'Usa', 'Stanza1', 'Torcia1', '0', 'Torcia1', 'Statua', '> La statua si apre come una porta e rivela il passaggio successivo.'),
    ...
    (299, 'Osserva', '0', '0', '0', 'Torcia2', '0', '> Una torcia, noti che ha dei segni sul manico potrebbe indicare che deve essere inserita in un meccanismo.'),
    ...
    (208, 'Osserva', 'Stanza5', 'End', '0', 'Occhio', '0', '> Noti che, dal punto in cui l''hai colpito, l''occhio sgorga lacrime.'),
    ...
    (218, '0', 'Stanza9', 'Acqua', '0', '0', '0', '> La stanza riflette ancora la luce grazie all''indovinello che hai risolto.'),
    ...
    (235, '0', 'Stanza10', 'SarcofagoAperto', '0', '0', '0', '> Entrando nella stanza, noti che dal sarcofago proviene un aura misteriosa.'),
    ...
    (238, '0', 'Stanza10', 'OsirideHekat', '0', '0', '0', '> Entrando nella stanza, sembra quasi che una forza ti spinga verso il faraone.'),
    (239, '0', 'Stanza10', 'OsirideNekhekh', '0', '0', '0', '> Entrando nella stanza, noti il faraone immobile di fronte al sarcofago.'),
    (240, 'Parla', 'Stanza6', 'Corretto', 'Mummia', '0', '0', '> "Che bravo che sei Nipotino, sapevo ce l''avresti fatta!"'),
    (241, 'Parla', 'Stanza6', 'Sbagliato', 'Mummia', '0', '0', '> "Nipotino non preoccuparti...riprova ancora"'),
    (242, 'Parla' ,'Stanza10', 'OsirideStart', 'Osiride' ,'0', '0', '> "Mortale, fai quello che ti ho detto e ti aspetteranno premi oltre ogni immaginazione."'),
    (243, 'Parla' ,'Stanza10', 'OsirideAnkh', 'Osiride' ,'0', '0', '> "Mortale, grazie per avermi portato la chiave della vita eterna"'),
    (244, 'Parla' ,'Stanza10', 'OsirideHekat', 'Osiride' ,'0', '0', '> "Mortale, grazie per avermi portato il mio scettro regale"'),
    (245, 'Parla' ,'Stanza10', 'OsirideNekhekh', 'Osiride' ,'0', '0', '> "Mortale, grazie per avermi portato il mio flagello sacro"'),
    (246, 'Osserva', 'Stanza10', 'OsirideStart', 'Osiride', '0', '0', '> Il faraone è coperto di bende, il suo sguardo penetrante è fisso su di te.'),
    (247, 'Osserva' ,'Stanza10', 'OsirideAnkh', '0' ,'0', '0', '> Ora intravedi la sua pella giovane dalle bende di cui è ricoperto.'),
    (248, 'Osserva' ,'Stanza10', 'OsirideHekat', '0' ,'0', '0', '> Il faraone tiene stresso a se il suo scettro regale.'),
    (249, 'Osserva' ,'Stanza10', 'OsirideNekhekh', '0' ,'0', '0', '> Il faraone tiene stresso a se il suo flagesso sacro.'),
    (250, 'Parla', 'Stanza10', 'SarcofagoChiuso', 'Osiride', '0', '0', '> "Se vuoi parlare con me, prima liberami da questa tomba"'),
    (251, 'Osserva', 'Stanza10', 'SarcofagoChiuso', 'Osiride', '0', '0', '> Non hai la vista a raggi X, non puoi vedere attraverso il sarcofago.'),
    (252, 'Osserva', 'Stanza10', 'OsirideStart', '0', 'Sarcofago', '0', '> Un sarcofago addobbato, il suo interno è ricoperto di seta per renderlo più confortevole al faraone.'),
    (253, '0', 'Stanza10', 'OsirideStart', '0', '0', '0', '> L''aura del faraone ti opprime, quasi spingendoti fuori dalla stanza.'),
    (254, 'Osserva', 'Stanza7', 'Corretto', '0', 'Mattonella', '0', '> Ora noti con esattezza tutti i simboli sulle mattonelle.'),
    (255, 'Osserva', 'Stanza10', 'OsirideAnkh', '0', 'Sarcofago', '0', '> Un sarcofago addobbato, il suo interno è ricoperto di seta per renderlo più confortevole al faraone.'),
    (256, 'Osserva', 'Stanza10', 'OsirideHekat', '0', 'Sarcofago', '0', '> Un sarcofago addobbato, il suo interno è ricoperto di seta per renderlo più confortevole al faraone.'),
    ...
    (268, 'Usa', 'Stanza3', 'AcquaOn', '0', 'Leva', '0', '> Tiri la leva e l''acqua smette di scorrere, ma appena la lasci riprende a farlo, ti servirebbe un modo per riuscire a tirarla dalla distanza'),
    (269, 'Usa', 'Stanza3', 'AcquaOff', '0', 'Leva', '0', '> Tiri la leva, l''acqua smette ancora di scorrere, ma ora non ti è di alcuna utilità');
