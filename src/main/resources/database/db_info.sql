...
INSERT INTO DESCRIZIONI (ID, COMANDO, STANZA, STATO, PERSONAGGIO, OGGETTO1, OGGETTO2, DESCRIZIONE) VALUES
    ...
    (110, 'Dai', 'Stanza10', 'OsirideStart', 'Osiride', 'Nekhekh', '0', '> "Un oggetto magico utile alla difesa del potere di un sovrano, cosi che possa governare incontrastato"'),
    (111, 'Dai', 'Stanza10', 'OsirideAnkh', 'Osiride', 'Nekhekh', '0', '> "Un oggetto magico utile alla difesa del potere di un sovrano, cosi che possa governare incontrastato"'),
    (112, 'Dai', 'Stanza10', 'OsirideHekat', 'Osiride', 'Nekhekh', '0', '> "Un oggetto magico utile alla difesa del potere di un sovrano, cosi che possa governare incostrastato"'),
    ...
    (242, 'Parla' ,'Stanza10', 'OssirideStart', 'Osiride' ,'0', '0', '> "Mortale, fai quello che ti ho detto, e ti aspetteranno premi oltre ogni immaginazione."'),
    (243, 'Parla' ,'Stanza10', 'OssirideAnkh', 'Osiride' ,'0', '0', '> "Mortale, grazie per avermi portato la chiave della vita eterna"'),
    (244, 'Parla' ,'Stanza10', 'OssirideHekat', 'Osiride' ,'0', '0', '> "Mortale, grazie per aver portato il mio scettro regale"'),
    (245, 'Parla' ,'Stanza10', 'OssirideNekhekh', 'Osiride' ,'0', '0', '> "Mortale, grazie per aver portato il mio flagello sacro"'),
