...
INSERT INTO DESCRIZIONI (ID, COMANDO, STANZA, STATO, PERSONAGGIO, OGGETTO1, OGGETTO2, DESCRIZIONE) VALUES
    ...
    (207, '0', 'Stanza6', 'Corretto', '0', '0', '0', '> Oltre al vecchio, noti anche che la porta dietro le sue spalle è aperta.'),
    (208, '0', 'Stanza6', 'Sbagliato', '0', '0', '0', '> Entrando nella stanza noti una mummia seduta su una sedia al centro della stanza.'),
    (209, 'Osserva', 'Stanza7', 'Corretto', '0', '0', '0', '> Il puzzle è stato risolto con successo.'),
    (210, '0', 'Stanza8', 'End', '0', '0', '0', '> Entrando nella stanza senti come se il muro avesse ruttato, si è goduto il lauto pasto!'),
