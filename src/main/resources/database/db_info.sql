...
INSERT INTO DESCRIZIONI (ID, COMANDO, STANZA, STATO, PERSONAGGIO, OGGETTO1, OGGETTO2, DESCRIZIONE) VALUES
    ...
    (242, 'Parla' ,'Stanza10', 'OssirideStart', '0' ,'0', '0', '> "Mortale, fai quello che ti ho detto, e ti aspetteranno premi oltre ogni immaginazione."'),
    (243, 'Parla' ,'Stanza10', 'OssirideAnkh', '0' ,'0', '0', '> "Mortale, grazie per avermi portato la chiave della vita eterna"'),
    (244, 'Parla' ,'Stanza10', 'OssirideHekat', '0' ,'0', '0', '> "Mortale, grazie per aver portato il mio scettro regale"'),
    (245, 'Parla' ,'Stanza10', 'OssirideNekhekh', '0' ,'0', '0', '> "Mortale, grazie per aver portato il mio flagello sacro"'),
    (246, 'Osserva', 'Stanza10', 'OsirideStart', '0', '0', '0', '> Il faraone è coperto di bende, il suo sguardo penetrante è fisso su di te'),
