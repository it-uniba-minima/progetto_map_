...
VALUES
    ...
    (2, 'Osserva', 'Desert', 'Start', '0', '0', '0', '> Difronte a te si pone una grande Sfinge egizia, dietro di lei è presente un imponente piramide che sembra quasi risplendere sotto la luce lunare.'),
    ...
    (8, 'Osserva', 'Desert', '0', '0', '0', '0', '> Noti una seconda Sfinge simile a un cane a protezione della piramide, accanto è presente anche una pala.'),
    (9, 'Osserva', 'Desert', 'Giusto', 'Pippo', '0', '0', '> Non sembra interessata alla tua presenza, ti avvicini ed è come se la sentissi russare.'),
    (10, 'Osserva', 'Desert', 'Sbagliato', 'Pippo', '0', '0', '> Sembra quasi che ti segue con gli occhi, ti avvicini ed è come se la sentissi sogghignare.'),
    ...
    (15, 'Osserva', 'Desert', '0', '0', 'Porta', '0', '> Due ancate ornate che fanno da entrata per la piramide.'),
    ...
    (21, 'Osserva', 'Stanza1', 'Buio', '0', '0', '0', '> La stanza è oscura, riesci a intravedere solo due stanze laterali che emettono luce leggera.'),
    ...
    (24, 'Osserva', 'Desert', '0', 'Sfinge', '0', '0', '> Una gigantesca Sfinge, sembra interessata alla tua presenza.'),
    ...
    (30, '0', 'Stanza2', 'SerpentiOn', '0', '0', '0', '> Entrando nella stanza, noti una torica che potrebbe tornare utile in caso di stanze buie, il problema che nel mezzo della stanza è presente una fossa piena di serpenti.'),
    ...
    (36, 'Osserva', '0', '0', '0', 'Corda', '0', '> Una corda durevole, probabilmente l''avrà lasciata Indiana Jhones'),
    (37, 'Osserva', '0', '0', '0', 'TorciaAccesa1', '0', '> Una torica, noti che ha dei segni sul manico potrebbe indicare che deve essere inserita in un meccanismo.'),
    (38, 'Osserva', '0', '0', '0', 'TorciaSpenta1', '0', '> Una torica, noti che ha dei segni sul manico potrebbe indicare che deve essere inserita in un meccanismo.'),
    ...
    (41, 'Osserva', 'Stanza3', 'AcquaOn', '0', 'Leva', '0', '> Una leva a pressione, ora è direzionata verso il basso.'),
    (42, 'Osserva', 'Stanza3', 'AcquaOff', '0', 'Leva', '0', '> Una leva a pressione, ora è direzionata verso l''alto, sembra quasi che tornerà alla posizione iniziale.'),
    ...
    (56, 'Osserva', 'Stanza1', 'Torce2', '0', '0', '0', '> La stanza ormai illuminata, si nota lo stato trascurato della stanza.'),
    ...
    (121, 'Osserva', '0', '0', '0', 'ArcoRotto', '0', '> UnArco senza spago, probabilmente Legoalas l''ha perso tempo fa.'),
    (122, 'Osserva', '0', '0', '0', 'FrecciaSmussata', '0', '> Una freccia con punta arrotondata, per non rischiare che qualcuno si facesse male.'),
    (123, 'Osserva', '0', '0', '0', 'Piuma', '0', '> Una Piuma sporca verso la punta, probabilmente era stata usata per scrivere.'),
    ...
    (139, '0', 'Stanza5', 'Start', '0', '0', '0', '> Entri nella stanza che apparentemente sembra vuota, noti solo la porta chiusa dall''altro lato della stanza.'),
    (140, 'Osserva', 'Stanza5', 'Start', '0', '0', '0', '> Noti che per terra sono presenti un Arco senza spago e una freccia smussata, sopra il soffitto invece è presente quello che sembra un occhio di vetro.'),
    ...
    (161, 'Osserva', 'Stanza6', '0', 'Mummia', '0', '0', '> La mummia sembra molto anziana ma ti fissa quasi con faccia felice, ti riscalda quasi il cuore a vederlo.'),
    ...
    (165, 'Osserva', 'Stanza6', '0', '0', '0', '0', '> Oltre alla mummia non noti molto altro in questa stanza.'),
    ...
    (183, 'Osserva', 'Stanza4', 'Giusto', '0', 'Pergamena', '0', '> La stanza ti fa ricordare tutti i momenti passati della tua adolescenza, sui banchi a studiare.');