...
INSERT INTO DESCRIZIONI (ID, COMANDO, STANZA, STATO, PERSONAGGIO, OGGETTO1, OGGETTO2, DESCRIZIONE) VALUES
    ...
    (102, 'Dai', 'Stanza10', 'OsirideStart', 'Osiride', 'Ankh', '0', '> "La chiave della vita, un oggetto che dona l''immortalità degli a chi lo possiede. Ti ringrazio per questo dono"'),
    (103, 'Dai', 'Stanza10', 'OsirideHekat', 'Osiride', 'Ankh', '0', '> "La chiave della vita, un oggetto che dona l''immortalità degli a chi lo possiede. Ti ringrazio per questo dono"'),
    (104, 'Dai', 'Stanza10', 'OsirideNekhekh', 'Osiride', 'Ankh', '0', '> La chiave della vita, un oggetto che dona l''immortalità degli a chi lo possiede. Ti ringrazio per questo dono"'),
    ...
    (244, 'Parla' ,'Stanza10', 'OsirideHekat', 'Osiride' ,'0', '0', '> "Mortale, grazie per aver portato il mio scettro regale."'),
    (245, 'Parla' ,'Stanza10', 'OsirideNekhekh', 'Osiride' ,'0', '0', '> "Mortale, grazie per aver portato il mio flagello sacro"'),
    (246, 'Osserva', 'Stanza10', 'OsirideStart', 'Osiride', '0', '0', '> Il faraone è coperto di bende, il suo sguardo penetrante è fisso su di te'),
    (247, 'Osserva' ,'Stanza10', 'OssirideAnkh', '0' ,'0', '0', '> Ora intravedi la sua pella giovane dalle bende di cui è ricoperto.'),
    (248, 'Osserva' ,'Stanza10', 'OssirideHekat', '0' ,'0', '0', '> Il faraone tiene stresso a se il suo scettro regale'),
    (249, 'Osserva' ,'Stanza10', 'OssirideNekhekh', '0' ,'0', '0', '> Il faraone tiene stresso a se il suo flagesso sacro'),
