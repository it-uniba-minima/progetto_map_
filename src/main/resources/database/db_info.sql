...
INSERT INTO DESCRIZIONI (ID, COMANDO, STANZA, STATO, PERSONAGGIO, OGGETTO1, OGGETTO2, DESCRIZIONE) VALUES
    ...
    (96, 'Osserva', 'Stanza10', 'SarcofagoAperto', '0', '0', '0', '> Il Sarcofago rivela la presenza di un faraone al suo interno, appena la guardi si rianima uscendo fuori dalla sua tomba.'),
    (97, 'Osserva', 'Stanza10', 'SarcofagoAperto', 'Osiride', '0', '0', '> Un faraone che a malapena si mantiene in piedi, quando ti guarda senti però un peso in corpo innimaginabile.'),
    ...
    (235, '0', 'Stanza10', 'SarcofagoAperto', '0', '0', '0', '> Entrando nella stanza, noti che dal sarcofago previene un aurea misteriosa'),
